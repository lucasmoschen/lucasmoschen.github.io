...
header:
  ...
  teaser: assets/images/book-md.png
read_time: true
author_profile: true
# gallery:
...
The book was based majourly in the main reference of the course: the book
[Logic and Proof](https://leanprover.github.io/logic_and_proof/). The ideia is
to build important topics in the area using a Theorem Proof, in special the
Lean. It was an interesing team project with several difficulties in the
process. 
